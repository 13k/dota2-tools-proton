...
class CustomGame:  # pylint: disable=too-many-instance-attributes
    def __init__(self, game: Dota2, name: str, src_path: str | PosixPath) -> None:
        ...
        self.src_content_path: PosixPath = self.src_path / "content"
        self.src_game_path: PosixPath = self.src_path / "game"
        self.addoninfo_file: PosixPath = self.src_game_path / "addoninfo.txt"
        self.content_path: PosixPath = self.game.addons_content_path / self.name
        self.game_path: PosixPath = self.game.addons_game_path / self.name
